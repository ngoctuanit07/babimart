...
class Flag_Saleproductpage_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function indexAction()
    {
        ...
        $rootCategory = Mage::getModel('catalog/category')
            ...
            ->setName($this->__('Sản phẩm giảm giá'))
            ->setMetaTitle($this->__('Sản phẩm giảm giá'))
            ->setMetaDescription($this->__('Sản phẩm giảm giá'))
            ->setMetaKeywords($this->__('Sản phẩm giảm giá'));
