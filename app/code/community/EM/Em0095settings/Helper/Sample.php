<?php
class EM_Em0095settings_Helper_Sample extends Mage_Core_Helper_Abstract
{
	protected $_themeSlug  = 'default/em0095';
	...
	protected $_megaMenuModel = 'em0095settings/megamenupro';
