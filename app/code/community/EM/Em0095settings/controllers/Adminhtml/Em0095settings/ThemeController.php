<?php
class EM_Em0095settings_Adminhtml_Em0095settings_ThemeController extends Mage_Adminhtml_Controller_Action
{
	protected $_prefixBlock = 'em0095_';
	protected $_prefixPage = 'em0095_';
	protected $_packageTheme = 'default/em0095';
